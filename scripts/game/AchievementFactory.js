angular.module('ninetynine').factory('AchievementFactory', ['LocalStorageHelper', 'Moment', 'Lodash', 'AchievementDisplayFactory', function(LocalStorageHelper, Moment, Lodash, AchievementDisplayFactory) {
    'use strict';
