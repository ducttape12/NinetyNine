angular.module('ninetynine').controller('MainCtrl', ['$scope', '$modal', '$state', 'Lodash', 'ComputerPlayerFactory',
    function($scope, $modal, $state, Lodash, ComputerPlayerFactory) {
        'use strict';

        var icons = ['diamond', 'beer', 'truck', 'bicycle', 'paw', 'money', 'coffee', 'star', 'heart', 'umbrella'];
        ...
        var assemblePlayers = function(playerName, playerIcon, playerCount) {
            ...
            var remainingIcons = exclude(icons, playerIcon);
